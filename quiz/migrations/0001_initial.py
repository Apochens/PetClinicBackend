    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.JSONField(validators=[quiz.validators.JsonFieldValidator('students')])),
                ('questions', models.JSONField(validators=[quiz.validators.JsonFieldValidator('questions')])),
            ],
        ),
        migrations.CreateModel(
